...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:testAODSIM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:testMINIAODSIM.root'),
