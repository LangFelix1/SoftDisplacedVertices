...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:testMINIAODSIM.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:5000'),
...
process.NANOEDMAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:testNANOAODSIM.root'),
